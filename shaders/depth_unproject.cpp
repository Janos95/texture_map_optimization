...
DepthShader& DepthShader::setDepthUnprojection(const Mn::Vector2& depthUnprojection) {
...
Mn::Vector2 calculateDepthUnprojection(const Mn::Matrix4& projectionMatrix) {
  return Mn::Vector2{(projectionMatrix[2][2] - 1.0f), projectionMatrix[3][2]} * 0.5f;
}
